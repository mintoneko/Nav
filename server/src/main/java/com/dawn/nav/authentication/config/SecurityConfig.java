package com.dawn.nav.authentication.config;

import com.dawn.nav.authentication.handler.exception.CustomAccessDeniedHandler;
import com.dawn.nav.authentication.handler.exception.CustomAuthenticationExceptionHandler;
import com.dawn.nav.authentication.handler.exception.CustomSecurityExceptionHandler;
import com.dawn.nav.authentication.handler.login.LoginFailHandler;
import com.dawn.nav.authentication.handler.login.LoginSuccessHandler;
import com.dawn.nav.authentication.handler.login.email.EmailAuthenticationFilter;
import com.dawn.nav.authentication.handler.login.email.EmailAuthenticationProvider;

import com.dawn.nav.authentication.handler.login.username.UsernameAuthenticationFilter;
import com.dawn.nav.authentication.handler.login.username.UsernameAuthenticationProvider;
import com.dawn.nav.authentication.resourceApi.adminApi.AdminJwtAuthenticationFilter;
import com.dawn.nav.authentication.resourceApi.publicApi.PublicApiAuthenticationFilter;
import com.dawn.nav.authentication.resourceApi.userApi.UserJwtAuthenticationFilter;
import com.dawn.nav.user.service.JwtService;
