      ...
      <div class="card-body">
        ...
        <form @submit.prevent="handleResetPwd" class="row g-3">
          <div class="col-md-12">
            ...
            <input v-model="resetPwdData.email" type="email" class="form-control" placeholder="请输入邮箱"
              id="validationEmail" required>
          </div>
          <label for="validationCode" class="form-label">验证码</label>
          <div class="input-group" style="margin: 0px;">
            <input v-model="resetPwdData.code" type="text" class="form-control" placeholder="请输入验证码" id="validationCode"
              required>
          ...
          <div class="col-md-12">
            ...
            <input v-model="resetPwdData.password" type="password" class="form-control" placeholder="请输入密码"
              id="validationPwd" required>
          </div>
          <div class="col-md-12">
            <label for="validationRePwd" class="form-label">确认密码</label>
            <input v-model="resetPwdData.rePassword" type="password" class="form-control" placeholder="请再次输入密码"
              id="validationRePwd" required>
          </div>
          <div class="col-12">
