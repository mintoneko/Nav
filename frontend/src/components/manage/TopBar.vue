    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary header-navbar-top">
      <div class="container-fluid header-navbar-top-content">
        <div class="d-flex align-items-center">
          ...
          <router-link class="navbar-brand ms-2 noto-serif-sc-brand" to="/manage/index">Nav导航管理端</router-link>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarText">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item header-navbar-top-item">
              <router-link class="nav-link noto-serif-sc-text" aria-current="page"
        ...
        <ul class="navbar-nav ms-auto d-none d-lg-flex">
          ...
          <li v-if="(!token) || token === ''" class="nav-item header-navbar-top-icon">
            <router-link class="nav-link" to="/login">
              <svg t="1727966561987" class="icon" viewBox="0 0 1024 1024" version="1.1"
                xmlns="http://www.w3.org/2000/svg" p-id="5152" width="20" height="20">
                <path
                  ...
                  fill="currentColor" p-id="5153"></path>
              </svg>
            </router-link>
          </li>
          <li v-else class="nav-item dropdown header-navbar-top-icon">
            <a class="nav-link dropdown-toggle no-caret" href="#" id="navbarDropdown" role="button"
              ...
              <svg t="1728716103482" class="icon" viewBox="0 0 1024 1024" version="1.1"
                ...
                <path
                  ...
                  fill="currentColor" p-id="5755"></path>
              </svg>
            </a>
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
              <!-- <li><a class="dropdown-item" href="/admin/index">管理</a></li> -->
              <li><a class="dropdown-item" style="pointer-events: none;">{{ greeting }} ！ {{ nowUser.nickname }}</a>
              </li>
              <li>
